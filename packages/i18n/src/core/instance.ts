...
// Default new visitors to Chinese; users who picked a language keep their choice.
// fallbackLng stays English so missing keys degrade to readable text, not raw keys.
const initialLng =
