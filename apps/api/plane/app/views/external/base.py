...
def get_llm_config() -> Tuple[str | None, str | None, str | None, str | None]:
    ...
    # Validate model is supported by provider, unless a custom base URL is
    # configured — custom OpenAI-compatible gateways expose arbitrary models
    if base_url is None and model not in provider.models:
        log_exception(
            ValueError(
